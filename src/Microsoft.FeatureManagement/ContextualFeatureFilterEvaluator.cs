...
namespace Microsoft.FeatureManagement
{
  ...
  /// </summary>
  class ContextualFeatureFilterEvaluator<TParameters> : IContextualFeatureFilter<object, TParameters>
  {
    private IFeatureFilterMetadata _filter;
    private Func<object, IFeatureFilterEvaluationContext<TParameters>, object, Task<bool>> _evaluateFunc;
    ...
    public ContextualFeatureFilterEvaluator(IFeatureFilterMetadata filter, Type appContextType)
    {
      ...
      {
        MethodInfo evaluateMethod = targetInterface.GetMethod(nameof(IContextualFeatureFilter<object, TParameters>.EvaluateAsync), BindingFlags.Public | BindingFlags.Instance);
    ...
    public Task<bool> EvaluateAsync(IFeatureFilterEvaluationContext<TParameters> evaluationContext, object context)
    {
    ...
    private static Func<object, IFeatureFilterEvaluationContext<TParameters>, object, Task<bool>> TypeAgnosticEvaluate(Type filterType, MethodInfo method)
    {
      //
      // Get the generic version of the evaluation helper method
      MethodInfo genericHelper = typeof(ContextualFeatureFilterEvaluator<TParameters>).GetMethod(nameof(GenericTypeAgnosticEvaluate),
      ...
      return (Func<object, IFeatureFilterEvaluationContext<TParameters>, object, Task<bool>>)typeAgnosticDelegate;
    }

    private static Func<object, IFeatureFilterEvaluationContext<TParameters>, object, Task<bool>> GenericTypeAgnosticEvaluate<TTarget, TParam1, TParam2, TReturn>(MethodInfo method)
    {
      Func<TTarget, IFeatureFilterEvaluationContext<TParameters>, TParam2, Task<bool>> func = (Func<TTarget, IFeatureFilterEvaluationContext<TParameters>, TParam2, Task<bool>>)Delegate.CreateDelegate
          (typeof(Func<TTarget, IFeatureFilterEvaluationContext<TParameters>, TParam2, Task<bool>>), method);

      Func<object, IFeatureFilterEvaluationContext<TParameters>, object, Task<bool>> genericDelegate = (object target, IFeatureFilterEvaluationContext<TParameters> param1, object param2) => func((TTarget)target, param1, (TParam2)param2);
