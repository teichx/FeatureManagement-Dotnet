...
{
    /// <summary>
    /// Interface for settings that are used to configure the <see cref="TimeWindowFilter"/> feature filter.
    /// </summary>
    public interface ITimeWindowFilterSettings : IFeatureFilterSettings
    {
        /// <summary>
        ...
        /// </summary>
        DateTimeOffset? Start { get; set; } // E.g. "Wed, 01 May 2019 22:59:30 GMT"
        ...
        /// </summary>
        DateTimeOffset? End { get; set; } // E.g. "Wed, 01 May 2019 23:00:00 GMT"
    }
}
