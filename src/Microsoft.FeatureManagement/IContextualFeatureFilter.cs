...
namespace Microsoft.FeatureManagement
{
    ...
    /// </summary>
    public interface IContextualFeatureFilter<TContext, TParameters> : IFeatureFilterMetadata
    {
        /// <summary>
        ...
        Task<bool> EvaluateAsync(IFeatureFilterEvaluationContext<TParameters> featureFilterContext, TContext appContext);
    }
}
