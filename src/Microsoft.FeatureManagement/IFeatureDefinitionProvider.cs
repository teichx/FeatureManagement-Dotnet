...
namespace Microsoft.FeatureManagement
{
    ...
    /// </summary>
    public interface IFeatureDefinitionProvider<TParameters>
    {
        /// <summary>
        ...
        Task<IFeatureDefinition<TParameters>> GetFeatureDefinitionAsync(string featureName);
        ...
        IAsyncEnumerable<IFeatureDefinition<TParameters>> GetAllFeatureDefinitionsAsync();
    }
}
