...
{
    [FilterAlias(Alias)]
    class CustomTargetingFilter : IFeatureFilter<TargetingFilterSettings>
    {
        ...
        public Task<bool> EvaluateAsync(IFeatureFilterEvaluationContext<TargetingFilterSettings> context)
        {
